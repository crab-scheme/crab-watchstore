; test/g5-list-pagination.scm — cw-qyk (G5): LIST limit/continue conformance,
; scaled to >=100k keys.
;
...
;
; Run from repo root:  crabscheme run test/g5-list-pagination.scm
;   CWS_G5_N=100000 CWS_G5_LIMIT=500 crabscheme run test/g5-list-pagination.scm
...
(define db (string-append "/tmp/cws-g5-page-" run-tag "-a-s0"))
